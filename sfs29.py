...
try:
    ...
    def count_peaks(pressures, timestamps):
        ...
        return len(peaks), peak_start_times, peak_end_times, peak_durations
    
    # Calculate peaks, peak start times, peak end times, and peak durations for FSR1
    peaks_fsr1, peak_start_times_fsr1, peak_end_times_fsr1, peak_durations_fsr1 = count_peaks(pressures_fsr1, timestamps_fsr1)
    
    # Calculate peaks, peak start times, peak end times, and peak durations for FSR2
    peaks_fsr2, peak_start_times_fsr2, peak_end_times_fsr2, peak_durations_fsr2 = count_peaks(pressures_fsr2, timestamps_fsr2)
